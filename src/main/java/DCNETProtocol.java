...
public class DCNETProtocol implements ZThread.IAttachedRunnable {
    ...
    public static void main(String[] args) {
        ...
        ZMQ.Socket receiverThread = ZThread.fork(context, new DCNETProtocol(), room);
    ...
    public void run(Object[] args, ZContext ctx, ZMQ.Socket pipe) {
        ...
        ZMQ.Socket receiver = ctx.createSocket(ZMQ.SUB);
